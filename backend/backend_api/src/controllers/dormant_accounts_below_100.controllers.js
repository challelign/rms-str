const dormantAccountBelow100Reason = require("../models/dormant_accounts_below_100.model");
...
//   dormantAccountBelow100Reason.getAll(page, countPerPage, req.session.branch_code ,  (err, data) => {
...
exports.update = (req, res) => {
  if (req.session.autenticated) {
    ...
    const reason = new dormantAccountBelow100Reason(req.body);
