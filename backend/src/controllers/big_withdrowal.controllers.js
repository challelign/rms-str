...
exports.findAll = (req, res) => {
  if (req.session.autenticated) {
   ...
   // const { perPageCount } = req.params;
    bigWithdrowReason.getAll(page, countPerPage, req.session.branch_code ,  (err, data) => {
...
exports.update = (req, res) => {
  ...
  bigWithdrowReason.updateById(withdrowId, reason, req.session.user_id, (err, data) => {


LoggedUser.update_action(1,0,0,0,0,0,req.session.user_id, (err, data) => {  });
    if (err) {
