...
const LoggedUser = ({}) => {
	...
	const columns = [
		{
			name: "You can search logged users by their Branch name, Branch code, Name and Date",
									...
									<Typography>
										<Typography>
											...
											{row.dormant_account_count != 0
												? row.dormant_account_count +
												  " Dormant account updates, "
												: ""}
	...
	const [paginationResetLeadingBranch, setPaginationResetLeadingBranch] =
		useState(false);
	const [paginationResetLeadingUser, setPaginationResetLeadingUser] =
		useState(false);
	...
	const [totalRowCountLeadingBranch, setTotalRowCountLeadingBranch] =
		useState(1);
	const [totalRowCountLeadingUser, setTotalRowCountLeadingUser] = useState(1);
	const [dataFetched, setDataFetched] = useState(false);
	const [dataFetchedLeadingBranch, setDataFetchedLeadingBranch] =
		useState(false);
	const [dataFetchedLeadingUser, setDataFetchedLeadingUser] = useState(false);
